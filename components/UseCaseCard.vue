<template class="phantom">
  <NuxtLink v-if="usecase.length > 0" :to="usecase[0].path">
    ...
    <div class="relative">
      ...
      <svg v-if="(title==='Atlas of (un)constrained climate projections')|(title==='Attribution of a small scale, heavy flash flood event to climate change')" width="156" height="36" class="absolute right-2 top-1">
        <rect
          x="3"
          y="3"
          rx="10"
